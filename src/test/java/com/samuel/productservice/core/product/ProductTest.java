...
public class ProductTest {
    ...
    class Reconstitute {
        ...
        void shouldThrowExceptionWhenIdIsNull() {
            ...
            assertThat(exception.getMessage()).contains("Product identity (ID) cannot be null during reconstitution");
        }
        ...
        void shouldNotReconstituteProductWithInvalidData(
                String sku, String name, BigDecimal stock, BigDecimal cost, BigDecimal price, String expectedMessage) {
        ...
        void shouldCollectMultipleErrorsOnReconstitution() {
            ...
            // Act & Assert
            final var expectedError = assertThrows(NotificationException.class, () -> {
                Product.reconstitute(existingId, invalidSku, invalidName, invalidStock, validCost, invalidPrice);
            });
